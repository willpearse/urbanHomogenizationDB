...
if ARGV.length == 4
  if File.exist? ARGV[0]
    ...
    if ARGV[4] == "1"
      ...
      merger = merge_cpp([iTree, veg_survey, veg_transect, lawn_survey, phone_survey, soil, metadata])
      iTree, veg_survey, veg_transect, lawn_survey, phone_survey, soil, metadata = merger[0]
    end
