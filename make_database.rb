...
if ARGV.length == 2
  if File.exist? ARGV[0]
    ...
    db.execute "CREATE TABLE City_Parcel_Plot (city_parcel_plot TEXT, cpp_index TEXT)"
    add_to_data_base(city_parcel_plot, db, "City_Parcel_Plot", nil)
