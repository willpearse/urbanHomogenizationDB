 ...
 curr_file = UniSheet.new file_name
  curr_file.each do |line|
    if line[0] and line[0] != "Sample ID"
      ...
      output << {:date=>[line[8]],:core_id=>[line[7]],:city_parcel=>[line[2]+"_"+line[3].to_s],:site_no=>[line[9]],:core_no=>[line[10]],:plot_no=>[line[11]],:depth=>[line[12]],:total_L=>[line[13]],:notes=>[notes],:core_sections=>[line[15]],:section_length=>[line[16]],:volume=>[line[17]], :tot_sub_rock_vol=>[line[18]], :wet_weight=>[line[19]], :dry_weight=>[line[20]], :dry_weight_sub_rock_weight=>[line[21]], :density=>[line[22]], :root_mass=>[line[23]], :rock_mass=>[line[24]], :rock_vol=>[line[25]], :microb_biomass=>[line[26]], :respiration=>[line[27]], :NO2_over_NO3=>[line[28]], :NH4=>[line[29]], :bio_N=>[line[30]], :mineral=>[line[31]], :nitrogen=>[line[32]], :moisture=>[line[33]], :DEA=>[line[34]], :percent_sand=>[sand], :pH=>[line[36]]}
    end
  end
  return output
end
